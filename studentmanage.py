...
main = Tk()
main.title('School Management System By Utkarsh/Abhay/deepankar')
...
Label(main, text="SCHOOL MNAGEMENT SYSTEM", font=headlabelfont, bg='Skyblue').pack(side=TOP, fill=X)
...
Label(right_frame, text='Students Records', font=headlabelfont, bg='Lightblue', fg='Black').pack(side=TOP, fill=X)
